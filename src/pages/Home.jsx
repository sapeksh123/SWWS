...
<div className="flex flex-col sm:flex-row gap-4 mb-12">
  <a href="tel:+917987696387">
    <button className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 text-lg rounded-lg font-semibold transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:scale-105">
      <Phone className="h-5 w-5 " />
      Call Now
    </button>
  </a>
  <Link href="/enquiry">
    <button className="w-full sm:w-auto border-2 border-emerald-400 text-emerald-200 hover:bg-emerald-400 hover:text-white px-8 py-4 text-lg rounded-lg font-semibold transition-all shadow-[0_0_20px_rgba(16,185,129,0.6)] hover:scale-105">
      Get Free Quote →
    </button>
  </Link>
</div>
